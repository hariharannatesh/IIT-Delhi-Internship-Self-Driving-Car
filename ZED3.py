...
def _process(img , temp):
    ...
    #edges1 = cv2.GaussianBlur(edges1,(11,11),0)
    ...
    if lb and rb is not None:
      ...
      req_angle = cross_track_error(k,l,temp.shape[0],o,p,(o+p)/2)
      cv2.putText(temp, str(req_angle), (20,20), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255),2, lineType=cv2.LINE_AA)
      #print temp.shape
...
class ImageCvBridge(object):
	...
	def run(self):
		...
		frame = cv_image
		frame = frame[frame.shape[0]-200:frame.shape[0]-100,100:frame.shape[1]-50]
